...
const BUILDINGS = {
    ...
    CASTLE:   { name: 'Castle',   category: 'MILITARY', tier: 2, plots: 10, cost: 1500, emoji: '🏯', desc: '+2 Offense. +4 Stability. Upkeep: 100 🥩/day.', income_wealth: 0, food_prod: 0, food_cost: 100, ore_prod: 0, ore_consumption: 0, metallurgy_prod: 0, pop_cap_bonus: 100, stab_bonus: 4, upgrade_from: 'BARRACKS' },
    PALACE:   { name: 'Palace',   category: 'MILITARY', tier: 3, plots: 12, cost: 2000, emoji: '👑', desc: '+3 Offense. +6 Stability. Upkeep: 150 🥩/day.', income_wealth: 0, food_prod: 0, food_cost: 150, ore_prod: 0, ore_consumption: 0, metallurgy_prod: 0, pop_cap_bonus: 300, stab_bonus: 6, upgrade_from: 'CASTLE' },
...
const UPBRINGINGS = {
    ...
    ECHOS:   { name: 'The Echoing Peaks',   bonuses: { stat_cha: 3, stat_mot: 1, stat_men: -2 }, desc: 'Life spent in high song and fragile peace.' },
    WARD:    { name: 'The Bleak Wards',     bonuses: { stat_int: 3, stat_mot: 1, stat_wis: -2 }, desc: 'Maddening elixirs and forbidden truths.' },
    FRINGES: { name: 'The Scorched Earth',  bonuses: { stat_mot: 2, stat_men: 2, stat_int: -1 }, desc: 'Survival ignores letters.' }
};
